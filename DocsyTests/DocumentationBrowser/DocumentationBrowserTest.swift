//
//  DocumentationBrowserTest.swift
//  Docsy
//
//  Copyright © 2024 Noah Kamara.
//

@testable import DocSee
import DocumentationKit
import Foundation
import Testing

@Suite("SQLiteDocumentationRepository")
struct SQLiteDocumentationRepositoryTests {
    let repository: any DocumentationRepository

    init() {
        self.repository = try! ApplicationDB().documentation
    }
